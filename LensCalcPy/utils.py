...
# %% auto 0
__all__ = ['ut_interp', 'ut_interp_mw', 'm_low_interp', 'm_high_interp', 'dist_mw', 'dist_m31', 'density_mw', 'density_m31',
...
import pickle
from .interpolations.interps import ut_interp, ut_interp_mw
...
def make_ut_interp(n_points=40, ds = 770):
    ...
    # Calculate ut_arr for the current m
        return np.array([u_t_finite(m, d, ds) for d in d_arr])
