...
# %% auto 0
__all__ = ['rhoc', 'rs', 'G', 'ds', 'c', 'fpbh', 'ut', 'obsTime', 'kpctokm', 'htosec', 'rEarth', 'l', 'b', 'zthinSol',
           'zthickSol', 'zthin45', 'rsol', 'rdBreak', 'rthin', 'rthick', 'rho_thin_Sol', 'rho_thick_Sol', 'x0', 'y0',
           'z0', 'cperp', 'cpar', 'rho0_B', 'Rc', 'alphabar']
