...
# %% auto 0
__all__ = ['rhoc', 'rs', 'G', 'rhocM31', 'rsM31', 'c', 'fpbh', 'ut', 'kpctokm', 'htosec', 'rEarth', 'r_max', 'ds', 'survey_area',
           'obsTime', 'n_sources', 'l', 'b', 'dsM31', 'efficiency', 'lam', 'zthinSol', 'zthickSol', 'zthin45', 'rsol',
