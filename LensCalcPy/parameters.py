...
# %% auto 0
__all__ = ['rhoc', 'rs', 'G', 'rhocM31', 'rsM31', 'c', 'fpbh', 'ut', 'kpctokm', 'htosec', 'rEarth', 'r_max', 'dsM31', 'ds',
           'n_sources', 'obsTime', 'l', 'b', 'efficiency', 'lam', 'survey_area', 'zthinSol', 'zthickSol', 'zthin45',
           'rsol', 'rdBreak', 'rthin', 'rthick', 'use_max_density', 'rho_thin_Sol', 'rho_thick_Sol', 'x0', 'y0', 'z0',
           'cperp', 'cpar', 'rho0_B', 'Rc', 'alphabar']
